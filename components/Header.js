...
export default function Example() {
  return (
    <Popover className='sticky top-0 left-0 right-0 bg-[#F4EDE4] z-50'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6'>
        <div className='flex items-center justify-between border-b-2 py-6 md:justify-start md:space-x-10'>
          ...
          <div className='-my-2 -mr-2 md:hidden'>
            <Popover.Button className='inline-flex items-center justify-center rounded-md bg-[#F4EDE4] p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none'>
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      "group inline-flex items-center rounded-md bg-[#F4EDE4] text-base font-medium hover:text-gray-900 focus:outline-none"
                    )}>
                    <span>Services</span>
                    <BiChevronDown
                      className={classNames(
                  ...
                  <Transition
                    ...
                    <Popover.Panel className='absolute z-10 -ml-4 mt-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2'>
                      <div className='overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5'>
                        <div className='relative grid gap-6 bg-[#F4EDE4] px-5 py-6 sm:gap-8 sm:p-8'>
                          {services.map((item) => (
                            <a
                              key={item.name}
                              href={item.href}
      ...
      <Transition
        ...
        <Popover.Panel
          ...
          <div className='divide-y-2 divide-[#F4EDE4] rounded-lg bg-[#F4EDE4] shadow-lg ring-1 ring-black ring-opacity-5'>
